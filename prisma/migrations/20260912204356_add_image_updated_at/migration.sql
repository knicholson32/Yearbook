...
INSERT INTO "new_images" ("altitude", "aspectRatio", "caption", "cropHeight", "cropWidth", "cropX", "cropY", "date", "dateWarningDismissed", "exif", "full", "hash", "height", "hex", "hexa", "i1024", "i128", "i256", "i512", "i768", "id", "isDark", "isHDR", "isLight", "latitude", "lens", "longitude", "make", "model", "monthId", "original", "originalExtension", "pendingForId", "rgb", "rgba", "sort", "userId", "width") SELECT "altitude", "aspectRatio", "caption", "cropHeight", "cropWidth", "cropX", "cropY", "date", "dateWarningDismissed", "exif", "full", "hash", "height", "hex", "hexa", "i1024", "i128", "i256", "i512", "i768", "id", "isDark", "isHDR", "isLight", "latitude", "lens", "longitude", "make", "model", "monthId", "original", "originalExtension", "pendingForId", "rgb", "rgba", "sort", "userId", "width" FROM "images";
DROP TABLE "images";
