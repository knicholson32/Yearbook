/*
  ...
  - You are about to drop the column `i1024` on the `images` table. All the data in the column will be lost.
  - You are about to drop the column `i2048` on the `images` table. All the data in the column will be lost.
